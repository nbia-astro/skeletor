...
In this section we consider the solution to \cref{eq:dux/dtau} and
\ref{eq:duy/dtau} in the special case where there is no rotation, i.e.
$\Omega=0$. We find
\begin{align}
  \label{eq:dux/dtau}
...
from \cref{eq:ux-prime} that $\tilde{u}_{x'} = U(a)$ and using \cref
{eq:dx/dtau} we find that
\begin{equation}
