...
\begin{equation}
  \rho = \rho_0 \left(1 + \pder{U}{a} \tau\right)^{-1} \ .
\end{equation}
If we choose $U(a) = A \sin{k a}$ the solution for the density in the
primed coordinate will be the same as for the standard 1D Burgers' equation.
